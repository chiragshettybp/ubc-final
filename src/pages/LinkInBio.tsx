  ...
  return <div className="min-h-screen bg-black p-4">
      <div className="max-w-md mx-auto">
        ...
        <div className="space-y-3">
          {countryLinks.map((item, index) => <Button key={index} onClick={() => handleCountryClick(item.paypalLink, item.country)} className="w-full h-16 bg-gradient-to-r from-yellow-400 via-yellow-300 to-yellow-400 text-black font-semibold hover:brightness-105 transition-all duration-200 text-lg">
        ...
        <div className="mt-8 text-center">
          ...
          <Button onClick={() => window.location.href = '/'} variant="outline" className="mt-4 border-yellow-400 text-yellow-400 hover:bg-yellow-400 hover:text-black">
            Back to Home
          </Button>
        </div>
      </div>
