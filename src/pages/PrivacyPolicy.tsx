      ...
      <div className="flex flex-col items-center pt-4 pb-8 px-4">
        <div className="w-full max-w-md mx-auto py-8">
          <div className="flex items-center justify-center mb-6">
            <ShieldCheck size={32} className="text-gray-400 mr-2" />
          ...
          <div className="space-y-6 text-sm text-gray-300">
            <div className="border-b border-gray-700 pb-4">
              <div className="flex items-center mb-2">
                <Database size={20} className="text-gray-400 mr-2" />
            ...
            <div className="border-b border-gray-700 pb-4">
              <h2 className="text-lg font-semibold mb-2 text-white">Cookies and Tracking Technologies</h2>
              <p>
            ...
            <div className="border-b border-gray-700 pb-4">
              <h2 className="text-lg font-semibold mb-2 text-white">Your Rights</h2>
              <p className="mb-2">
            ...
            <div className="pt-2">
              ...
              <p>
                If you have any questions about this Privacy Policy, please contact us at <a href="mailto:hello@bleame.com" className="text-gray-400 hover:text-gray-300 hover:underline">hello@bleame.com</a>.
              </p>
            </div>
          </div>
        </div>
