...
const UnitedKingdom = () => {
  const handlePurchase = () => {
    window.open('https://www.paypal.com/ncp/payment/A65LNZJ2CSQH4', '_blank', 'noopener,noreferrer');
    toast({
    ...
    <div className="max-w-md mx-auto bg-black">
      ...
      <div className="flex flex-col items-center pt-4 pb-8">
        ...
        <div className="w-full px-4 my-4">
          <CTAButton onClick={handlePurchase} paypalLink="https://www.paypal.com/ncp/payment/A65LNZJ2CSQH4" />
        </div>
        <PaymentMethods />
        <OrderTimer />
        <BenefitBadges />
      ...
      <Footer />
      <BottomOfferBar paypalLink="https://www.paypal.com/ncp/payment/A65LNZJ2CSQH4" />
    </div>
  );
};
