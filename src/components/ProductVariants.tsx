...
const VariantOption: React.FC<{
  ...
  return (
    <div 
      className={`relative w-full p-4 rounded-lg border ${active 
        ? 'bg-purple-lighter border-purple' 
    ...
    <div className="w-full px-4 space-y-2">
      ...
      <div className="flex items-center mt-4 ml-4">
        ...
        <p className="text-xs text-orange">
          <span className="font-bold">Body Scrub</span> <span className="font-semibold">included for the next </span>
