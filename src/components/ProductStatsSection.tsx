...
const ProductStatsSection: React.FC = () => {
  ...
  return (
    <section className="w-full py-12 px-4 bg-yellow-50">
      <motion.div 
      ...
      >
        ...
        <div className="divide-y divide-yellow-200 mb-8">
          {statItems.map((item, index) => (
            <div key={index} className="flex items-center py-5 space-x-6">
        ...
        <button 
          ...
          className="w-44 h-12 bg-yellow-500 hover:bg-yellow-600 text-yellow-900 font-bold rounded-lg mb-8 relative overflow-hidden shadow-lg transition-all duration-300"
        >
