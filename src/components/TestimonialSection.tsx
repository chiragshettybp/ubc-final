...
const TestimonialCard: React.FC<{
  ...
  return <motion.div className="bg-white rounded-lg p-5 shadow-md border border-gray-200 flex flex-col h-full" initial={{
    opacity: 0,
    y: 20
  }} animate={{
    opacity: 1,
    ...
    boxShadow: "0 10px 25px -5px rgba(0, 0, 0, 0.1)"
      ...
      <div className="flex items-center mb-4">
        ...
        {testimonial.verified && <div className="ml-auto px-2 py-1 rounded-full flex items-center bg-yellow-300">
  ...
  return <section className="w-full py-8 bg-white">
      <div className="max-w-md mx-auto">
        <div className="text-center mb-6 px-6">
          <motion.h2 className="text-xl font-bold text-black mb-2" initial={{
          opacity: 0,
          y: -10
        }} animate={{
          opacity: 1,
        ...
        delay: 0.8
          ...
          <Link to="/reviews" className="text-gray-600 font-semibold text-sm flex items-center px-4 py-2 border border-gray-300 rounded-full hover:bg-gray-100 hover:text-black transition-colors">
            See all reviews
